...
int LSM6DS3Class::begin()
{
  ...
  //set the gyroscope control register to work at 208 Hz, 1000 dps and in bypass mode
  writeRegister(LSM6DS3_CTRL2_G, 0x58);
...
int LSM6DS3Class::readGyroscope(float& x, float& y, float& z)
{
  ...
  x = data[0] * 1000.0 / 32768.0;
  y = data[1] * 1000.0 / 32768.0;
  z = data[2] * 1000.0 / 32768.0;
...
{
  uint8_t value = readRegister(LSM6DS3_CTRL2_G);
  return value;
}
